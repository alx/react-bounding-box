  ...
  render: () => (
    ...
    >
      <div style={{ textAlign: 'center', marginBottom: '30px' }}>
        <h1
          style={{ color: '#2563eb', fontSize: '2.5rem', marginBottom: '10px' }}
        >
          🎯 React Bounding Box Component
        </h1>
        <div
        ...
        >
          <img
            src="https://github.com/alx/react-bounding-box/workflows/CI/badge.svg"
            alt="CI"
          />
          <img
            src="https://badge.fury.io/js/react-bounding-box.svg"
            alt="npm version"
          />
          <img
            src="https://codecov.io/gh/alx/react-bounding-box/branch/master/graph/badge.svg"
            alt="codecov"
          />
        </div>
        <p
          style={{ fontSize: '1.2rem', color: '#64748b', marginBottom: '20px' }}
        >
          React Bounding Box Component displays bounding boxes on an image
      ...
      >
        <h2 style={{ color: '#15803d', marginBottom: '15px' }}>
          🚀 Quick Start
        </h2>
        <div
          style={{
    ...
    />
      ...
      >
        ...
        <p style={{ marginBottom: '15px' }}>
          The component supports pixel-level segmentation for advanced computer
          vision applications:
        </p>
        <div
          style={{
...
/>`}</pre>
      ...
      >
        <h2 style={{ color: '#7c2d12', marginBottom: '15px' }}>
          📚 Navigation Guide
        </h2>
        <div
          style={{
        ...
        >
          ...
          >
            ...
            <p style={{ color: '#64748b', fontSize: '14px' }}>
              Enhanced performance with 40% faster rendering and modern React
              patterns
            </p>
          </div>
          <div
...
npm run build`}</pre>
      ...
      >
        ...
        <p style={{ marginBottom: '15px' }}>
          This project includes automated security scanning and maintains zero
...
npm run security:check`}</pre>
      ...
      >
        ...
        <ul style={{ listStyle: 'none', padding: 0 }}>
          <li style={{ marginBottom: '8px' }}>
            ⚡ <strong>BREAKING:</strong> Modernized to React 18+ with new JSX
            transform
          </li>
          <li style={{ marginBottom: '8px' }}>
            🔧 <strong>BREAKING:</strong> Updated minimum Node.js requirement to
            16+
          </li>
          <li style={{ marginBottom: '8px' }}>
      ...
      >
        ...
        <p style={{ color: '#64748b', marginBottom: '20px' }}>
          Explore the interactive examples in the sidebar to see all the
          features in action!
        </p>
        <div
          style={{
        ...
        >
          <a
            href="https://github.com/alx/react-bounding-box"
            style={{
          ...
          <a
            href="https://www.npmjs.com/package/react-bounding-box"
            style={{
              display: 'inline-block',
              padding: '10px 20px',
              background: '#dc2626',
